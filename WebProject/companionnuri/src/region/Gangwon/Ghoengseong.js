    ...
    const fetchUsers = async () => {
      try {
        ...
        const response = await axios.get(
          'https://grpc-proxy-server-mkvo6j4wsq-du.a.run.app/v1/regcodes?regcode_pattern=4273*&is_ignore_zero=true'
        );
