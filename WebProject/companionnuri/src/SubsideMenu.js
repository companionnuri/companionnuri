      ...
      <nav>
        <ul className='m-0 p-0'>
          <li className='list-unstyled' style={submenuItem}>
            <button className='d-flex flex-column align-items-center justify-content-center w-100 h-100 ' style={subMenuItemBtn}>
              <i class="fa-solid fa-arrow-pointer" style={submenuItemIcon}></i>
              <span className='mt-1' style={submenuItemTitle}>검색별</span>
            </button>
          </li>
          <li className='list-unstyled' style={submenuItem}>
            <button className='d-flex flex-column align-items-center justify-content-center w-100 h-100 ' style={subMenuItemBtn}>
              <i class="fa-solid fa-map" style={submenuItemIcon}></i>
              <span className='mt-1' style={submenuItemTitle}>지도별</span>
            </button>
          </li>
        </ul>
          {/* {value ? 
